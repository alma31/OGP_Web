...
function getEventFacebook(token) {
    FB.api('/302706460080999/events', 'GET', {
        ...
        for (var i = 0; i < response.data.length; i++) {
            ...
            $("#row_event_responsive").append("<div id='divEvent' class='col-md-12'><ul class='rslides_event'><li><img src='" + listEvent.cover.source + "' class='event_image center-block' alt='Responsive image'></li></ul><div id='grid-title_goutte' class='col-md-12 text-center'><div class='testcenter'><img class='img_goutte' src='img/svg-collé-55063-x-27.svg' alt=''><h3 class='title_event'>" + listEvent.name + "</h3><img class='img_goutte' src='img/svg-collé-55067-x-27.svg' alt=''></div></div><div class='col-lg-12 text-center'><h4 class='title_event'>LE " + listEvent.start_time + "</h4></div><div class='col-lg-2'></div><div class='col-lg-8'><p><strong>Au programme : </strong></br>" + listEvent.description + "</p></br><div class='div_subscrib'><a href='https://www.facebook.com/events/" + listEvent.id + "' class='button btn_subscribe'>S'inscrire a l'evenement</a></div></div><div class='col-lg-2'></div></div>");
            $("#row_event").append("<div id='divEvent' class='col-md-12'><ul class='rslides_event'><li><img src='" + listEvent.cover.source + "' class='event_image center-block' alt='Responsive image'></li></ul><div id='grid-title_goutte' class='col-md-12 text-center'><div class='testcenter'><img class='img_goutte' src='img/svg-collé-55063-x-27.svg' alt=''><h3 class='title_event'>" + listEvent.name + "</h3><img class='img_goutte' src='img/svg-collé-55067-x-27.svg' alt=''></div></div><div class='col-lg-12 text-center'><h4 class='title_event'>LE " + listEvent.start_time + "</h4></div><div class='col-lg-2'></div><div class='col-lg-8'><p><strong>Au programme : </strong></p></br>" + listEvent.description + "</p></br><div class='div_subscrib'><a href='https://www.facebook.com/events/" + listEvent.id + "' class='button btn_subscribe'>S'inscrire a l'evenement</a></div></div><div class='col-lg-2'></div></div>");
        }
    });
}
